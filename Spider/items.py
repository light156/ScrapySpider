...
class PersonItem(scrapy.Item):
    ...
    def get_insert_sql(self):
        insert_sql = """
               insert into person_table(website_order, person_id, name, sex, birth_date, death_date,
               absentee, maiden_name, spouse, wealth_at_death, claims, claim_role, claim_role_note, claim_id)
               values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
           """
        params = (self.get("website_order", ""), self.get("person_id", ""), self.get("name", ""), self.get("sex", ""),
                  self.get("birth_date", ""), self.get("death_date", ""), self.get("absentee", ""),
                  self.get("maiden_name", ""), self.get("spouse", ""), self.get("wealth_at_death", ""),
                  self.get("claims", ""), self.get("claim_role", ""), self.get("claim_role_note", ""),
                  self.get("claim_id", ""))
...
class ClaimItem(scrapy.Item):
    ...
    def get_insert_sql(self):
        insert_sql = """
            insert into claim_table(claim_id, claim_date, enslaved, money, money_s, money_d, colony, 
